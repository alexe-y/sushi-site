...
<header>
    <div class="container">
        <div class="header-wrap">
            ...
            <div class="tel header-item" id="basc"><i class="fas fa-phone"></i>&nbsp;(098) 765 43 21</div>
            <div class="basket header-item" id=""><!--<i class="fas fa-shopping-basket"></i><span class="jqcart-total-cnt"> x пусто</span>--></div>
        </div>
    </div>
</header>
